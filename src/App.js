...
function Home() {
  const [background, setBackground] = useState("#aeaeae");
  function setBg() {
    setBackground(
      "linear-gradient(270deg, #ff0000, #ff7700, #fffe00, #1fff00, #00cbff, #0a00ff, #9100ff, #ff00da)"
    );
  }
  ...
  return (
    <div className="body">
      ...
      <div className="airframe" style={scrollBarCSS}>
        <h1>Games</h1>
        <span id="hover">
          <div className="ds1">
            <img
